package com.example.myapplicationpractica04permiso02dsm104
...
class MainActivity : AppCompatActivity() {
    ...
    private fun hacerSolicitudPermiao(){
       ...
       when(requestCode){
           CODIGOSOLICITUDGRABAR ->{
               if(grantResults.isEmpty() || grantResults[0] !=PackageManager.PERMISSION_GRANTED){
                   Log.i(TAG,"Permiso a sido denegado por el ususario")
                   ...
                   /*Escribir codigo de permiso concedido, segun se requiere */
